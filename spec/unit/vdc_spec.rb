...
describe VCloudSdk::VDC do
  ...
  describe "storage_profile_exists?" do
    ...
    context "storage profile with matching name does not exist" do
      it "returns false" do
        subject.storage_profile_exists?("xxx").should be false
      end
    end
  end
  ...
  describe "vapp_exists?" do
    ...
    context "vapp with matching name exists" do
      it "returns true" do
        subject.vapp_exists?(VCloudSdk::Test::Response::VAPP_NAME).should be true
      end
    end

    context "vapp with matching name does not exist" do
      it "returns false" do
        subject.vapp_exists?("xxx").should be false
      end
    end
  end
  ...
  describe "#disk_exists?" do
    context "disk with matching name exists" do
      it "returns true" do
        subject.disk_exists?(disk_name).should be true
      end
    end

    context "disk with matching name does not exist" do
      it "returns false" do
        subject.disk_exists?("xxx").should be false
      end
    end
  end
