  ...
  describe "#memory" do
    ...
    context "Allocation Unit is incorrect" do
      it "raises CloudError" do
        subject
          .should_receive(:parse_memory_allocation_units)
          .and_return 1
  ...
  describe "#parse_memory_allocation_units" do
    ...
    context "allocation_units is in invalid form" do
      it "raises ApiError" do
        expect do
          subject
            .send(:parse_memory_allocation_units, "bit * 2^20")
