module VCloudSdk
    module Test
      module Response
        ...
        INSTANTIATED_VM_POWER_OFF_LINK = "#{URL}/api/vApp/vm-#{INSTANTIATED_VM_ID}/power/action/powerOff"
        ...
        INSTANTIATED_VM_UNDEPLOY_LINK = "#{URL}/api/vApp/vm-#{INSTANTIATED_VM_ID}/action/undeploy"
        ...
        INSTANTIATED_VM_PRODUCT_SECTION_LINK = "#{URL}/api/vApp/vm-#{INSTANTIATED_VM_ID}/productSections/"

        INSTANTIATED_VM_INSERT_MEDIA_LINK = "#{URL}/api/vApp/vm-#{INSTANTIATED_VM_ID}/media/action/insertMedia"

        INSTANTIATED_VM_EJECT_MEDIA_LINK = "#{URL}/api/vApp/vm-#{INSTANTIATED_VM_ID}/media/action/ejectMedia"
        ...
        INSTANTIATED_VM_EJECT_MEDIA_TASK_DONE = (File.read(Test.spec_asset(
          "instantiated_vm_eject_media_task_done.xml")) %
          [INSTANTIATED_VM_INSERT_MEDIA_TASK_ID,
           INSTANTIATED_VM_INSERT_MEDIA_TASK_LINK, URL,
           INSTANTIATED_VM_INSERT_MEDIA_TASK_ID, URL, URL, URL]).strip
        ...
        INSTANTIAED_VAPP_RESPONSE = (File.read(Test.spec_asset(
          ...
          INSTANTIATED_VAPP_NETWORK_CONFIG_SECTION_LINK, ORG_NETWORK_NAME, URL, INSTANTIATED_VM_ID,
        ...
        INSTANTIAED_VAPP_ON_RESPONSE = (File.read(Test.spec_asset(
          ...
          URL, VAPP_ID, URL, VAPP_ID, URL, VAPP_ID, URL, VAPP_ID, URL, VAPP_ID,
          ORG_NETWORK_NAME, INSTANTIATED_VAPP_NETWORK_CONFIG_SECTION_LINK,
          INSTANTIATED_VAPP_NETWORK_CONFIG_SECTION_LINK, ORG_NETWORK_NAME, URL, INSTANTIATED_VM_ID,
          INSTANTIATED_VM_LINK, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL,
        ...
        INSTANTIAED_VAPP_POWERED_OFF_RESPONSE = (File.read(Test.spec_asset(
          ...
          VAPP_ID, URL, VAPP_ID, URL, URL, VAPP_ID, URL, VAPP_ID, URL, VAPP_ID,
          URL, VAPP_ID, URL, VAPP_ID, URL, VAPP_ID, URL, VAPP_ID, URL, VAPP_ID,
          URL, VAPP_ID, ORG_NETWORK_NAME, INSTANTIATED_VAPP_NETWORK_CONFIG_SECTION_LINK,
          INSTANTIATED_VAPP_NETWORK_CONFIG_SECTION_LINK, ORG_NETWORK_NAME, URL, INSTANTIATED_VM_ID,
          INSTANTIATED_VM_LINK, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
        ...
        INSTANTIATED_VM_RESPONSE = (File.read(Test.spec_asset(
          ...
          INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL,
          INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, INSTANTIATED_VM_PRODUCT_SECTION_LINK, URL,
          INSTANTIATED_VM_ID, INSTANTIATED_VM_INSERT_MEDIA_LINK, INSTANTIATED_VM_EJECT_MEDIA_LINK,
          INSTANTIATED_VM_ATTACH_DISK_LINK, INSTANTIATED_VM_DETACH_DISK_LINK,
          URL, INSTANTIATED_VM_ID, RECONFIGURE_VM_LINK, INSTANTIATED_VAPP_LINK, URL, INSTANTIATED_VM_ID,
          SCSI_CONTROLLER_ID, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL,
          INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL,
        ...
        INSTANTIATED_VM_WITH_ATTACHED_DISK_RESPONSE = (File.read(Test.spec_asset(
          "instantiated_vm_with_attached_disk_response.xml")) % [INSTANTIATED_VM_ID, URL,
          INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL,
          INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          INSTANTIATED_VM_INSERT_MEDIA_LINK, URL, INSTANTIATED_VM_ID,
          INSTANTIATED_VM_ATTACH_DISK_LINK, INSTANTIATED_VM_DETACH_DISK_LINK,
          URL, INSTANTIATED_VM_ID, INSTANTIATED_VAPP_LINK, URL, INSTANTIATED_VM_ID,
          SCSI_CONTROLLER_ID, INDY_DISK_URL, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL,
          INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
          URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL,
          INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID, URL, INSTANTIATED_VM_ID,
